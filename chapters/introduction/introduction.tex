...
The WFD has its main focus on large water bodies \textgreater 10~$km^2$ catchmentsize, whereas ERA has its focus on small water bodies \textless 10~$km^2$ \citep{brock_aquatic_2006}.
