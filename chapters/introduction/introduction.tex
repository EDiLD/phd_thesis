...
The earth is currently experiencing a functional change driven by human activities which are so far-reaching, that a new geological epoch "Anthropocene" has been proposed \citep{steffen_anthropocene_2011, waters_anthropocene_2016}. 
...
%%%! Compared RACs from ERA with monitoring data
