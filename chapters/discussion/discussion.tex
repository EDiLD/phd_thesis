...
% lentic systems
We provide results in chapter~\ref{sec:smallstreams} only for small streams, however, data on lentic systems is even more scarce. 
Although, more the 95\% of German standing waters are lentic small waterbodies a recent meta-analysis revealed that only 5\% of studies investigating pesticides in freshwaters were performed on lentic small water bodies \citep{lorenz_specifics_2016}.
The query to the federal states in chapter~\ref{sec:smallstreams} included also lotic systems.
However, the returned data revealed that there are currently no such monitoring data available \citep{brinke_umsetzung_2016}. 
...
Jowever, we also demonstrated current problems and further improvements of those are needed to safeguard freshwaters from chemicals.
...
%%% => biology / ecology
%%% Rico 2016 STOTEN habitat more influetial than pesticides in danube (big river)
