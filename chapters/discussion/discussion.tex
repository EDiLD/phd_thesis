...
Grab sampling likely underestimates chemical concentrations \citep{xing_influences_2013} because of short term peak concentrations \citep{wittmer_significance_2010}.
...
In chapter~\ref{sec:smallstreams} we compiled and analysed 
...
% More than 29% of the 25,872 eshwater species assessed for the IUCN Red List of Threatened SpeciesTM (‘Red List’) are globally threatened with extinction (IUCN, 2015)
...
Integration monitoring data and risk assessment data is a mandatory requirement for landscape level ecotoxicology and risk assessment \citep{cairns_developing_1996, focks_challenge:_2014} and needed for model validation \citep{knabel_regulatory_2012}. 
