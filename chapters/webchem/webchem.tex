...
\renewcommand{\hlnum}[1]{\textcolor[rgb]{0.15, 0.15, 0.15}{#1}}%
\renewcommand{\hlstr}[1]{\textcolor[rgb]{0.15, 0.15, 0.15}{#1}}%
\renewcommand{\hlcom}[1]{\textcolor[rgb]{0.15, 0.15, 0.15}{\textit{#1}}}%
\renewcommand{\hlopt}[1]{\textcolor[rgb]{0,0,0}{#1}}%
\renewcommand{\hlstd}[1]{\textcolor[rgb]{0.15, 0.15, 0.15}{#1}}%
\renewcommand{\hlkwa}[1]{\textcolor[rgb]{0.15, 0.15, 0.15}{\textbf{#1}}}%
\renewcommand{\hlkwb}[1]{\textcolor[rgb]{0.15, 0.15, 0.15}{#1}}%
\renewcommand{\hlkwc}[1]{\textcolor[rgb]{0.15, 0.15, 0.15}{#1}}%
\renewcommand{\hlkwd}[1]{\textcolor[rgb]{0.15, 0.15, 0.15}{\textbf{#1}}}%
...
\begin{alltt}
\hlkwd{R> install.packages}\hlstd{(}\hlstr{"webchem"}\hlstd{)}
\hlkwd{R> library}\hlstd{(}\hlstr{"webchem"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{R> data}\hlstd{(}\hlstr{"jagst"}\hlstd{)}
\hlkwd{R> head}\hlstd{(jagst)}
\end{alltt}
\begin{verbatim}
...
\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{R> data}\hlstd{(}\hlstr{"lc50"}\hlstd{)}
\hlkwd{R> head}\hlstd{(lc50)}
\end{alltt}
\begin{verbatim}
##        cas        value
## 4  50-29-3    12.415277
...
\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{R> is.inchikey}\hlstd{(}\hlstr{'BQJCRHHNABKAKU-KBQPJGBKS-AN'}\hlstd{)}
\end{alltt}
...
\end{verbatim}
\begin{alltt}
\hlkwd{R> is.cas}\hlstd{(}\hlstr{'64-17-6'}\hlstd{)}
\end{alltt}
...
\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{R> is.inchikey}\hlstd{(}\hlstr{'BQJCRHHNABKAKU-KBQPJGBKSA-5'}\hlstd{,}
